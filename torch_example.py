...
if __name__ == "__main__":
    ...
    # Create a function which maps the input data to the labels.
    # This is the function which the neural network will try to predict.
    for i in range(100):
        label_data[i, 0] = input_data[i, 0]
        label_data[i, 1] = input_data[i, 1] * input_data[i, 2]
